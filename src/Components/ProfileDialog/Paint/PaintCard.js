...
componentDidMount(){
  ...
  var return_time = [];
  var return_cats = ['Networking', 'Security', 'Collaboration', 'IoT', 'Data Center', 'Service Provider', 'Communications'];
var  array = ['Networking', 'Security', 'Collaboration', 'IoT', 'Data Center', 'Service Provider', 'Communications'];
